...
**Status:** 12 Lottie files — a reusable core subset of the 40-asset gallery's highest-traffic
...
**Preview:** open `lottie/gallery.html` in a browser to see all 12 animations playing side by side
